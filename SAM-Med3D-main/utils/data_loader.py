...
class Dataset_Union_ALL(Dataset):
    ...
    def _set_file_paths(self, paths):
        ...
        for path in paths:
            ...
            if os.path.exists(d):
                # Sort file list to ensure consistent ordering across train/val splits
        ...
        # Support train/validation split using every split_num-th sample starting from split_idx
        # E.g., split_num=5, split_idx=0 -> indices 0,5,10,15,... (training)
        #       split_num=5, split_idx=1 -> indices 1,6,11,16,... (validation)
        if self.split_num > 1:
