...
def build_sam3D_vit_h(checkpoint=None, num_classes=2):
    return _build_sam3D(
...
def build_sam3D_vit_l(checkpoint=None, num_classes=2):
    return _build_sam3D(
...
def build_sam3D_vit_b(checkpoint=None, num_classes=2):
    return _build_sam3D(
...
def build_sam3D_vit_b_ori(checkpoint=None, num_classes=2):
